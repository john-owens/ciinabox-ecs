...
namespace :ciinabox do
  ...
  task :init do |t, args|
    ...
    domain_shared = yesno("Is this domain used in a public and private hosted zone", false)
    if domain_shared then
      ciinabox_tools_hosted_zone_id = get_input("Enter hosted zone id to be used with this stack:")
    end
